...
#ANOVA IV
#GES = "Generalized Eta Square"
#PES = "Partial Eta Squared"
# Effect size resource url "https://imaging.mrc-cbu.cam.ac.uk/statswiki/FAQ/effectSize#:~:text=The%20general%20rules%20of%20thumb,squared%20than%20to%20eta-squared."

anova_test(df_new1 , dv = chol , between = age_groups)
# Our ges value is 0.03 which it's between small and medium 
# if the effect size is high, the gap between mean will be high too